...
const state = {
  ...
  stripes: [
    { offset: 0, color: "#231f20", height: 13 },
    { offset: 6.3, color: "#231f20", height: 20 },
    // { offset: 1.3, color: "#231f20", height: 10 }
  ],
  diamonds: [
    { x: 0, offset: 0.15, pos: new Vector3(), scale: 0.6, factor: 1.8 },
    { x: 2, offset: 1.1, pos: new Vector3(), scale: 0.8, factor: 2.1 },
    { x: -5, offset: 2, pos: new Vector3(), scale: 0.5, factor: 2.5 },
